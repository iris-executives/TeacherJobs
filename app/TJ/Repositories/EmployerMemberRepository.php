...
class EmployerMemberRepository implements Contracts\Employers\Repositories\EmployerMemberRepositoryInterface {
    ...
    public function __construct(EmployerMemberInterface $employer)
    { 
